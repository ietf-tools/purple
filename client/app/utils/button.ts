export const commonClasses =
  'rounded-md font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed'
export const classForBtnType = {
  ...
  delete: `${commonClasses} text-white bg-red-700 hover:bg-red-600`,
