...
<template>
  <div>
    <div
      ...
      <button type="button" @click="props.reload" class="border ml-3 border-gray-200 px-2 py-1">
        Try again
      </button>
    </div>
    ...
    <div
      v-if="props.commentList && props.commentList.length === 0"
      class="text-center text-sm mt-4 mb-2">
