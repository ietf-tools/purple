        ...
        <div
          ...
          <HeadlessTransitionChild
            ...
            <HeadlessDialogPanel
                  ...
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div class="mt-2">
                      <p class="text-sm text-gray-500 dark:text-neutral-400">
                        This will change the disposition to <strong>withdrawn</strong>. Add an
                        optional comment.
                      </p>
                    </div>
                    <div class="mt-4">
              ...
              <div
                class="bg-gray-50 dark:bg-neutral-800 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-2">
                <BaseButton
                  btn-type="delete"
                ...
                <BaseButton
                  btn-type="cancel"
                  class="inline-flex w-full justify-center sm:w-auto"
                  :disabled="isSubmitting"
                  @click="cancel"
                  >Cancel</BaseButton
                >
...
const handleWithdraw = async () => {
  ...
  try {
    ...
    snackbarForErrors({
      snackbar,
      defaultTitle: 'Draft withdrawn, but saving the comment failed',
      error
    })
  }
