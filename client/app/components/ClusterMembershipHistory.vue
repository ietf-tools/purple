<template>
  <div>
    ...
    <table v-else class="w-full text-sm border-collapse">
      <thead>
        <tr
          class="border-b border-gray-300 dark:border-gray-600 text-left text-xs uppercase text-gray-500 dark:text-gray-400">
      ...
      <tbody>
        <tr
          ...
          :key="`${entry.time}-${entry.draftName}-${entry.type}`"
