...
const whatIveGot = {
  number: 1,
  documents: [
    { name: "draft-ietf-tls-esni", rfc_number: null },
    { name: "draft-ietf-tls-svcb-ech", rfc_number: null },
  ],
};
  ...
  [
    {
      ...
      draftName: "draft-ietf-tls-esni",
      targetDraftName: "draft-ietf-tls-svcb-ech",
    },
  ],
  [],
];
